      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" style="background: rgb(38, 214, 141);color:white" href="{{ url('myappointment') }}">My Appointment</a>
              </li>
...
<div align="center" style="padding: 70px">
    <table >
        ...
        <tr style="background-color: black" align="center">
            ...
            <td style="padding:10px;color:white"><a href="{{ url('cancelappoint', $appoint->id) }}" class="btn btn-danger" onclick="return confirm('are you sure to delete this?')">cancel</a></td>
        </tr>
        @endforeach
